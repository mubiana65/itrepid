        ...
        <div className="bg-lightBackground dark:bg-gray-900 text-lightText dark:text-darkText min-h-screen">
          ...
          <header className="relative h-96 md:h-80 lg:h-96 bg-blue-800 text-center flex flex-col items-center justify-center text-white">
            ...
            <div className="absolute inset-0 w-full h-full">
              <video
                src="https://videos.pexels.com/video-files/6169116/6169116-uhd_2560_1440_25fps.mp4"
                autoPlay
                loop
                muted
                playsInline
          ...
          <main className="container mx-auto py-12 px-4 md:px-8 lg:px-16">
            ...
            <section data-aos="fade-right" className="mb-10">
              ...
              At Itrepid, we are committed to providing high-quality supplies to support your projects and operations. Whether you’re in construction, manufacturing, or any other industry, our extensive product range ensures you find exactly what you need.
              </p>
            </section>
