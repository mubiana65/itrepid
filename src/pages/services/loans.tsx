        ...
        <div className="bg-lightBackground dark:bg-gray-900 text-lightText dark:text-darkText min-h-screen">
          ...
          <header className="relative h-96 md:h-80 lg:h-96 bg-blue-800 text-center flex flex-col items-center justify-center text-white">
            ...
            <div className="absolute inset-0 w-full h-full">
              <video
                src="https://videos.pexels.com/video-files/6266432/6266432-uhd_2560_1440_25fps.mp4"
                autoPlay
                loop
                muted
                playsInline
              ...
              />
              <img
                src="https://images.pexels.com/photos/5816291/pexels-photo-5816291.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1"
            ...
            <div className="relative z-10">
              ...
              <p className="text-xl" data-aos="fade-up">
                Discover the benefits of our Loan services.
              </p>
            </div>
          </header>
          ...
          <main className="container mx-auto py-12 px-4 md:px-8 lg:px-16">
            ...
            <section data-aos="fade-right" className="mb-10">
              ...
              At Itrepid, we understand that securing the right financing is essential to achieving your goals. Whether you're looking to purchase a home, expand your business, or cover unexpected expenses, our range of loan products and personalized service can help you make it happen.
              </p>
            </section>
